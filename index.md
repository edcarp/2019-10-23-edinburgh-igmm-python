...
address: "MEC computing Lab 1, The Anne. Ferguson Building. WGH"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "Oct 23rd"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Dr Juan Rodriguez Herrera"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Kevin.Donnelly@igmm.ed.ac.uk"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
{% endcomment %}
<p id="requirements">
  <strong>Requirements:</strong> The course will be run on the Windows 10 computers in the Medical Education Centre computing lab. Participants may bring a laptop with a
